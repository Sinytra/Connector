...
public class ModuleLayerMigrator {
    ...
    /**
     * "Moves" a module from the {@link IModuleLayerManager.Layer#BOOT BOOT} layer to {@link IModuleLayerManager.Layer#GAME GAME}
     ...
     * <p/>
     * Libraries transferred by this method are only used by minecraft after the {@link IModuleLayerManager.Layer#GAME GAME} layer becomes available.
     ...
     * @return the new jar to be placed on the {@link IModuleLayerManager.Layer#GAME GAME} layer
     */
    public static SecureJar moveModule(String moduleName) {
        try {
            ...
            // Create new provider, must be done before the original's packages are emptied
