...
public final class TransformerIds {
    ...
    public static final String CLASS_ANALYSIS = "connector:analysis";
    public static final String METHOD_PATCHES = "connector:patches";
    public static final String ACCESS_REDIRECT = "connector:access_redirect";

    private TransformerIds() {
    }
}
